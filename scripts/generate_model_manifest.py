...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate the trusted v0.1.0 model manifest")
    ...
    payload = {
        ...
        "download": {
            "archive_name": "LinguaRelay-0.1.0-models.zip",
            "url": "https://github.com/MuzeAnisichael/LinguaRelay/releases/download/v0.1.0/LinguaRelay-0.1.0-models.zip",
